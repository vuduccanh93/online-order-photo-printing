<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admintrator.Master" AutoEventWireup="true"
    CodeBehind="AccUser.aspx.cs" Inherits="ODPP.Admin.AccUser" %>
                                ...
                                <asp:Repeater ID="rpUser" runat="server" OnItemCommand="rpUser_ItemCommand">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:ImageButton ID="cmdEdit" runat="server" AlternateText="Sửa" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"UserID")%>'
                                                    CommandName="Edit" CssClass="Edit" ImageUrl="assets/img/edit.png" ToolTip="Sửa" />
                                                <asp:ImageButton ID="cmdDelete" runat="server" AlternateText="Xóa" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"UserID")%>'
                       ...
                       <%-- <form>--%>
                        <div class="row">
                            ...
                            <div class="col-lg-9 pd-20">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" col-lg-4">
                                        <input placeholder="Confirm Password" class="validate[required] form-control" type="password"
                                            runat="server" name="txtPassword2" id="txtPassword2" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-4" for="txtEmail">
                                        E-mail</label>
                                    <div class=" col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" col-lg-4">
                                        <div class="input-group">
                                            <input placeholder="Phone number" runat="server" class="validate[required,minSize[10],MaxSize[10]] form-control"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-4" for="txtBirth">
                                        Date Of birth</label>
                                    <div class=" col-lg-4">
                                        <input type="text" class="form-control" runat="server" value="02-16-2012" id="txtBirth"
                                            name="txtBirth">
