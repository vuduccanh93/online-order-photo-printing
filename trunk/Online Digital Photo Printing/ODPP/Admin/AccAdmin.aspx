<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admintrator.Master" AutoEventWireup="true"   CodeBehind="AccAdmin.aspx.cs" Inherits="ODPP.Admin.AccAdmin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3><i class="fa fa-group"></i> Admin Account Manager</h3>
</asp:Content>
...
<tbody>
            ...
            <asp:Repeater ID="rpAadmin" runat="server">
                <ItemTemplate>
                    <tr>
                        <td><asp:CheckBox ID="chkSelect" runat="server" /></td>
                        <td style="display:none"><%#Eval("AdminID").ToString()%></td>
                        <td><%#Eval("UserName").ToString()%></td>
                        <td><%#Eval("AdminRole").ToString()%></td>
                    ...
                    AlternateText="Sửa" 
                    CommandArgument='<%#DataBinder.Eval(Container.DataItem,"AdminID")%>' 
                ...
                <form class="form-horizontal" id="popup-validation">
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-lg-4">
                            ...
                            <input placeholder="Confirm Password" class="validate[required,equals[pass1]] form-control" type="password" runat="server" name="pass2" id="pass2"/>
                        </div>
                    </div>
