<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admintrator.Master" AutoEventWireup="true"
    CodeBehind="Order.aspx.cs" Inherits="ODPP.Admin.Order" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3>
        <i class="  fa fa-truck"></i>Order Photo Manager</h3>
</asp:Content>
                                ...
                                <asp:Repeater ID="rpOrder" runat="server" OnItemCommand="rpOrder_ItemCommand">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <%#Eval("Status").ToString() == "False" ? "Not Assigned" : "Assigned"%>
                                            </td>
                                            <td>
                                                <asp:ImageButton ID="cmdUp" runat="server" AlternateText="Xóa" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"OrderID")%>'
                                                    CommandName="Assigned" CssClass="Delete" ImageUrl="assets/img/valid.jpg" OnClientClick="javascript:return confirm('Assigned photo?');"
                                                    ToolTip="Assigned" />
                                                <asp:ImageButton ID="cmdEdit" runat="server" AlternateText="View" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"OrderID")%>'
                                                    CommandName="View" CssClass="Edit" ImageUrl="assets/img/view.png" ToolTip="View" />
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
            ...
            <div class="col-lg-12">
                ...
                <div class="toolbar">
                    ...
                    <div id="collapse2" class="body collapse in">
                        <a id="A1" href="javascript:void(0);" onclick="window.history.go(-1);" data-toggle="tooltip"
                            class="btn btn-default btn-sm"><i class="fa fa-undo"></i>Back </a>
                        <div class="row">
                            ...
                            <div class="pd-10">
                                <table id="Table1" class="table table-bordered table-condensed table-hover table-striped"
                                    <%if(rpDetail.Items.Count<=0){ %>style="display:none;" <%} %> width="90%">
                                    <thead>
                                        <tr>
                                            <th>
                                                Size
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="rpDetail" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td>
                                                        <%#getSize(Eval("SizeID").ToString())%>
                                                    </td>
                                                    <td>
                                                        <%#Eval("ImageName").ToString()%>
                                                    </td>
                                                    <td>
                                                        <asp:Image ID="imgshow" runat="server" Width="74px" Height="60px" ImageUrl='<%#"Handler.ashx?id=" +Eval("DetailsID") %>' />
                                                    </td>
                                                    <td>
